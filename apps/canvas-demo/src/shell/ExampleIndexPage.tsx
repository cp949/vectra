...
export function ExampleIndexPage({ categories, examples, onSelectExample }: ExampleIndexPageProps): ReactElement {
    ...
    >
      <section style={{ maxWidth: 1040, margin: '0 auto', padding: '48px 32px' }}>
        <header style={{ marginBottom: 40 }}>
          ...
          <h1 style={{ margin: '0 0 16px', maxWidth: 720, fontSize: 56, lineHeight: 1 }}>Canvas Demo</h1>
          <p style={{ margin: 0, maxWidth: 680, color: '#cbd5e1', fontSize: 18, lineHeight: 1.6 }}>
            Geometry and math examples with editable source, Canvas preview, console output, and URL-addressable
            examples.
          </p>
        </header>
