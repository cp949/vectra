/**
 * SVG `<polygon>` points attribute 문자열을 파싱하여 XYObjectWritable 배열에 기록한다.
 *
...
/**
 * SVG `<polygon>` points attribute 문자열을 파싱하여 out 배열에 기록한다.
 *
 ...
 * @returns out (편의 반환)
 */
export function parseSvgPolygonInto(out: XYObjectWritable[], input: string): XYObjectWritable[] {
  out.length = 0;
