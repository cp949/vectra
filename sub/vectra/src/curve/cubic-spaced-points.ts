...
import { cubicSpacedPointsInto } from './cubic-spaced-points-into';

/**
 * cubic Bezier curve를 arc-length 기준으로 균등 분포한 새 XYObjectWritable[] 배열을 반환한다.
 *
 ...
 * 성능 최적화가 필요하면 `cubicSpacedPointsInto`를 사용한다.
 *
 * @param p0 curve 시작점
 * @param p1 첫 번째 제어점
 * @param p2 두 번째 제어점
 ...
 */
export function cubicSpacedPoints(
  p0: XYInput,
  p1: XYInput,
  p2: XYInput,
  p3: XYInput,
  ...
  return cubicSpacedPointsInto([], p0, p1, p2, p3, count, options);
}
