...
/**
 * quadratic Bezier curve의 파라미터 t 위치 unit tangent vector를 out에 기록하고 out을 반환한다.
 *
 * derivative를 정규화한 unit vector를 반환한다.
 ...
 */
export function quadraticTangentAtInto<Out extends XYWritable>(
  out: Out,
  p0: XYInput,
  p1: XYInput,
  p2: XYInput,
