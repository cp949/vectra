...
import { cubicLookupTableInto } from './cubic-lookup-table-into';

/**
 * cubic Bezier curve의 uniform t cumulative chord-length lookup table을 새 배열로 반환한다.
 *
 ...
 * 성능 최적화가 필요하면 `cubicLookupTableInto`를 사용한다.
 *
 * @param p0 curve 시작점
 * @param p1 첫 번째 제어점
 * @param p2 두 번째 제어점
 ...
 */
export function cubicLookupTable(
  p0: XYInput,
  p1: XYInput,
  p2: XYInput,
  p3: XYInput,
  ...
  return cubicLookupTableInto([], p0, p1, p2, p3, steps);
}
