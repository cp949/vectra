...
/**
 * vector에 pose rotation만 적용한 결과를 out에 기록하고 out을 반환한다.
 *
 ...
 */
export function transformVectorByPoseInto<Out extends XYWritable>(out: Out, pose: Pose2Like, vector: XYInput): Out {
