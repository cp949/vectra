...
import type { InfiniteLineLike, PathCommand, PathMeasurementOptions } from '../types';

/**
 * infinite-line과 path가 교차하면 true를 반환한다.
 *
 ...
 */
export function intersectsPathInfiniteLine(
