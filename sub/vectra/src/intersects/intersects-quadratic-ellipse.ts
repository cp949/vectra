...
/**
 * quadratic Bezier segment와 ellipse가 교차하면 true를 반환한다.
 *
 ...
 */
export function intersectsQuadraticEllipse(
  p0: XYInput,
  p1: XYInput,
  p2: XYInput,
  ellipse: EllipseLike,
  ...
  if (!allFinite([p0x, p0y, p1x, p1y, p2x, p2y, cx, cy, rx, ry])) return false;
