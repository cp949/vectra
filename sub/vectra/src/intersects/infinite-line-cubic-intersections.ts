...
import { infiniteLineCubicIntersectionsInto } from './infinite-line-cubic-intersections-into';

/**
 * infinite-line과 cubic Bezier curve의 교차점을 새 IntersectionHit[] 배열로 반환한다.
 *
 ...
 * 성능 최적화가 필요하면 `infiniteLineCubicIntersectionsInto`를 사용한다.
 *
 ...
 */
export function infiniteLineCubicIntersections(
  ...
  infiniteLineCubicIntersectionsInto(out, line, p0, p1, p2, p3, options);
  return out;
}
