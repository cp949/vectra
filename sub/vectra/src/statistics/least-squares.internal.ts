/**
 * least-squares solver의 옵션 검증, QR-based core solver, 잔차 계산 helper.
 *
 ...
 */
function assertFiniteMatrixEntries(
 ...
 * @param name error message에 사용할 인자 이름
 */
function assertFiniteVectorEntries(vector: readonly number[], name: string): void {
