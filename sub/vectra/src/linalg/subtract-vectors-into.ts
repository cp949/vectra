...
/**
 * 두 vector의 element-wise difference `out[i] = a[i] - b[i]`를 `out`에 기록하고 `out`을 반환한다.
 *
 ...
 */
export function subtractVectorsInto<Out extends VecWritable>(out: Out, a: VecLike, b: VecLike): Out {
